...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $message = '<p>'.LANG_VALUE_142.'<br> <a href="'.BASE_URL.'https://www.hamrokishan.com/reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">Click here</a>';
        
        $to      = $_POST['cust_email'];
        $subject = LANG_VALUE_143;
        $headers = "From: ayushsedhai@gmail.com" . BASE_URL . "\r\n" .
                   "Reply-To: dipalmalla@gmail.com" . BASE_URL . "\r\n" .
